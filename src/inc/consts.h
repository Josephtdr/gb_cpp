...
const unsigned int r_BG_PALLET         = 0xFF47; //bg colour pallet
const unsigned int r_SPRITE_PALLET1    = 0xFF48; //first sprite colour pallet
const unsigned int r_SPRITE_PALLET2    = 0xFF49; //second sprite colour pallet
